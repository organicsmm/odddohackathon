...
export const CITIES: City[] = [
  ...
  { city: 'Udaipur',       country: 'India', region: 'North India',      tags: ['lakes', 'palace', 'romantic'],            image: u('1582719188393-bb71ca45dbb9'), bestMonths: 'Sep–Mar',          currency: 'INR', language: 'Hindi, Mewari' },
  ...
  { city: 'Rishikesh',     country: 'India', region: 'North India',      tags: ['yoga', 'rafting', 'spiritual'],           image: u('1568430328012-21ed450453ea'), bestMonths: 'Sep–Apr',          currency: 'INR', language: 'Hindi, Garhwali' },
  ...
  { city: 'Amritsar',      country: 'India', region: 'North India',      tags: ['golden-temple', 'food', 'sikh'],          image: u('1524492412937-b28074a5d7da'), bestMonths: 'Nov–Mar',          currency: 'INR', language: 'Punjabi, Hindi' },
  ...
  { city: 'Pune',          country: 'India', region: 'West India',       tags: ['city', 'student', 'food'],                image: u('1602216056096-3b40cc0c9944'), bestMonths: 'Oct–Feb',          currency: 'INR', language: 'Marathi, Hindi' },
  { city: 'Ahmedabad',     country: 'India', region: 'West India',       tags: ['heritage', 'food', 'textile'],            image: u('1614082242765-7c98ca0f3df3'), bestMonths: 'Nov–Feb',          currency: 'INR', language: 'Gujarati, Hindi' },
  ...
  { city: 'Mysore',        country: 'India', region: 'South India',      tags: ['palace', 'silk', 'heritage'],             image: u('1606298855672-3efb63017be8'), bestMonths: 'Oct–Mar',          currency: 'INR', language: 'Kannada' },
  { city: 'Hampi',         country: 'India', region: 'South India',      tags: ['ruins', 'unesco', 'boulders'],            image: u('1602216056096-3b40cc0c9944'), bestMonths: 'Oct–Feb',          currency: 'INR', language: 'Kannada' },
  ...
  { city: 'Pondicherry',   country: 'India', region: 'South India',      tags: ['french', 'beach', 'colonial'],            image: u('1582510003544-4d00b7f74220'), bestMonths: 'Oct–Mar',          currency: 'INR', language: 'Tamil, French' },
  ...
  { city: 'Darjeeling',    country: 'India', region: 'East India',       tags: ['tea', 'mountains', 'toy-train'],          image: u('1626621341517-bbf3d9990a23'), bestMonths: 'Oct–Mar, Apr–Jun', currency: 'INR', language: 'Nepali, Bengali' },
  { city: 'Gangtok',       country: 'India', region: 'East India',       tags: ['mountains', 'monastery', 'sikkim'],       image: u('1626621341517-bbf3d9990a23'), bestMonths: 'Mar–Jun, Sep–Nov', currency: 'INR', language: 'Nepali, English' },
  { city: 'Shillong',      country: 'India', region: 'East India',       tags: ['hills', 'waterfall', 'music'],            image: u('1602216056096-3b40cc0c9944'), bestMonths: 'Oct–May',          currency: 'INR', language: 'Khasi, English' },
