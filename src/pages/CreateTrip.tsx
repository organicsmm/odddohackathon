...
export default function CreateTrip() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <form onSubmit={submit} className="space-y-5 rounded-2xl border border-border/60 bg-card p-6 shadow-soft">
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <Button type="submit" variant="hero" size="lg">Create trip</Button>
        </div>
      </form>
    </div>
  );
